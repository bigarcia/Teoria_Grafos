...
print("Para visualizar a imagem de forma ampliada, abra DFS_Dolphins_After.png na pasta do projeto\n")
#imprimindo grafo
nx.draw_networkx_labels(T,pos,labels=name)
nx.draw_networkx_edges(T,pos)
nx.draw(T,pos)
plt.savefig("DFS_Dolphins_After.png", dpi=96, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1)
plt.show()
plt.close()
